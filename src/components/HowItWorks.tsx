const STEPS = [
  ...
  { num: '2', title: 'OTA価格を一括取得', desc: '複数の予約サイトから最新価格を自動で取得します。' },
  { num: '3', title: '最安値を確認', desc: 'OTA別の価格ランキングで一番安いサイトが一目でわかります。' },
  { num: '4', title: 'そのまま予約', desc: '最安OTAのリンクをタップしてそのまま予約できます。' },
];
